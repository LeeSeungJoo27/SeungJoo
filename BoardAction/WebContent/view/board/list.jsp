...
<span class="w3-center  w3-large">
	...
	<p class="w3-right w3-padding-right-large">
		<a href="<%=request.getContextPath() %>/board/write.do?pageNum=${pageNum}">글쓰기</a>
	</p>
<c:if test="${count==0 }">
...
<a href="<%=request.getContextPath() %>/board/content.do?num=${article.num}&pageNum=${pageNum}">${article.subject}</a> 
 ...
 border="0" height="16">
  ...
  <c:if test="${ startPage>bottomLine}">
    ...
    <a href="list.jsp?pageNum=${startPage - bottomLine}">[이전]</a> </c:if>
...
<a href="list.jsp?pageNum=${startPage + bottomLine}">[다음]</a></c:if>
